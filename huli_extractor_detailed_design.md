# Huli Practice extractor — diseño técnico detallado

## Objetivo
Diseñar el flujo técnico real para extraer agenda y ocupación desde Huli Practice y persistir la información en `ClinicBridge`.

## Caso inicial
- médica: Liseth Alejandra Jones Ulate
- plataforma: Huli Practice
- perfil: `liseth-jones-huli`
...
2. validar `platform_registry` = `huli-practice`
3. obtener:
   - login_identifier
   - credential_ref
   - login_mode
...
## Flujo técnico
### 1. Login
- abrir la URL de acceso de Huli Practice
...
- si la UI muestra otra granularidad, normalizar al periodo objetivo
...
## Errores a manejar
- credencial inválida
- MFA o paso adicional no previsto
- cambio de layout
- agenda vacía
...
## Próxima fase
Implementar el conector real y homologar contrato con Clinic Web
